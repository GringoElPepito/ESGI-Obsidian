...
- RAID 60 : Requiert minimum 8 disques. On va réaliser plusieurs RAID 6 qui seront ensuite agrégés dans un RAID 0. Ce RAID fournit un niveau de sécurité supérieur au RAID 50 au détriment d'une perte d'espace disponible. Il permet notamment de supporter la perte de 2 disques par groupe RAID 6. On optera pour le 60 pour des volumes de données assez large et critique
