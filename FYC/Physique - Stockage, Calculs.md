...
- Le nombre de cœurs définit le nombre de tâche que le processeur va pouvoir traiter en parallèle. Cependant la notion est un peu plus complexe que ça, il existe 2 types de cœurs, les cœurs physiques et les cœurs logiques. Les cœurs physiques sont éléments physiques présent physiquement sur le processeur
