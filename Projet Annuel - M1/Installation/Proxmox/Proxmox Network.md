...
- VLAN -> Zone partagée entre tous les nœuds sur lesquels elle existe. Liable à une interface réseau (Physique ou virtuelle) des nœuds où sera diffusé la zone. Les zones
- QinQ -> Zone partagée entre tous les nœuds sur lesquels elle existe. Liable à une interface réseau (Physique ou virtuelle bridge) des nœuds où sera diffusé la zone
- VxLAN -> Zone partagée entre tous les nœuds sur lesquels elle existe. Liable à une interface réseau (Physique ou virtuelle bridge) des nœuds où sera diffusé la zone
- EVPN -> Zone partagée entre tous les nœuds sur lesquels elle existe. Liable à une interface réseau (Physique ou virtuelle bridge) des nœuds où sera diffusé la zone
