...
Voici les caractéristiques de notre machine de stockage san.cenexis.lan :
- CPU :
- RAM :
- Stockage :
- Interface réseau :
...
TrueNAS SCALE est un système d'exploitation spécialisé dans la gestion et mise en réseau de stockage. 