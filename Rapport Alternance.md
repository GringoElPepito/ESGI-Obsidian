...
Cette période en entreprise, a été pour moi une occasion de mettre à l'œuvre mes compétences techniques. En effet, Le service informatique étant formé uniquement de deux personnes avant mon arrivé, M. ILIE et son prédécesseur avaient orienté celui-ci principalement sur la gestion d'incident et de projet, en déléguant le plus possible les tâches techniques aux différents prestataires. À mon arrivée, cela a été quelque chose d'assez compliqué pour moi à appréhender, car dans mon expérience précédente nous réalisions tout par nous-même. J'ai donc dû m'adapter à cette nouvelle manière de travailler en comprenant qu'il était parfois plus pertinent de délégué une tâche dans le but de gagner en efficacité. Cependant voyant que mon profil était plus porté sur le technique, M. ILIE a décider d'internaliser certaines tâches comme le packaging des applications, la configuration des switches ou encore les tâches de Scripting. Ceci nous a permit de renégocier certains contrat de maintenance à la baisse
